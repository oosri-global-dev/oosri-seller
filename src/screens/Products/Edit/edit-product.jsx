          ...
          <FlexibleDiv className="tab__item">
              ...
              <FlexibleDiv className="50%" flexDir="column" alignItems="start" gap="24px">
                ...
                <div className="product__item">
                    ...
                    <Select placeholder="Input product display type" backgroundColor="#FAFAFA" options={productTypeItem} onChange={(e)=>{setProductType(e)}} width="100%" defaultValue={productType}/>
                </div>
                {/* Regular Price */}
                <div className="product__item">
                    <label htmlFor="Name">Regular Price(NGN)</label>
                    <CustomInput placeholder="Input Product Price" backgroundColor="#FAFAFA" type="number" onChange={(e)=>{handleSalesPrice(e.target.value)}}  value={regularPrice} />
                </div>
                {/* Sales Price */}
                <div className="product__item">
                    <label htmlFor="Name">Sales Price(NGN)</label>
                    <CustomInput placeholder="Input Product Price" backgroundColor="#FAFAFA" onChange={((e)=>{setSalesPrice(e.target.value)})} type="number" value={salesPrice} disabled/>
                </div>
              </FlexibleDiv>
              {/* right section */}
              <FlexibleDiv flexDir="column" gap="24px" alignItems="start" width="100%">
                ...
                </div>
                {
                  ...
                  <div className="product__item">
                      ...
                      <CustomInput placeholder="Input Product Height" backgroundColor="#FAFAFA" onChange={((e)=>{setHeight(e.target.value)})} value={height} type="number"/>
                  </div>
                  {/* Technique */}
                  <div className="product__item">
                      <label htmlFor="Name">Technique</label>
                      <CustomInput placeholder="Input Product Technique" backgroundColor="#FAFAFA" onChange={((e)=>{setTechnique(e.target.value)})} value={technique}/>
                  </div>
                  </>:category==="Textiles/Fabrics"?
                  <>
                  {/* Weight */}
                  ...
                  <div className="product__item">
                      ...
                      <CustomInput placeholder="Input Product Pattern" backgroundColor="#FAFAFA" onChange={((e)=>{setPattern(e.target.value)})} value={pattern}/>
                  </div>
                  {/* FabricType */}
                  <div className="product__item">
                      <label htmlFor="Name">Fabric Type</label>
                      <CustomInput placeholder="Input Product Fabric Type" backgroundColor="#FAFAFA" onChange={((e)=>{setFabricType(e.target.value)})} value={fabricType}/>
                  </div>
                  </>:category==="Pottery"?
                  <>
                      {/* Diameter */}
                      ...
                      <CustomInput placeholder="Input Product Diameter" backgroundColor="#FAFAFA" onChange={((e)=>{setDiameter(e.target.value)})} type="number" value={diameter}/>
                        </div>
                      {/* ClayType */}
                      <div className="product__item">
                          <label htmlFor="Name">Clay Type</label>
                          <CustomInput placeholder="Input Clay Type" backgroundColor="#FAFAFA" onChange={((e)=>{setClayType(e.target.value)})} value={clayType}/>
                      </div>
                      {/* Height */}
                      <div className="product__item">
                          <label htmlFor="Name">Height</label>
                          <CustomInput placeholder="Input Product Height" backgroundColor="#FAFAFA" value={height} onChange={((e)=>{setHeight(e.target.value)})} type="number" />
                      </div>
                      {/* Glaze */}
                      <div className="product__item">
                          <label htmlFor="Name">Glaze</label>
                          <CustomInput placeholder="Input Product Glaze" backgroundColor="#FAFAFA" onChange={((e)=>{setGlaze(e.target.value)})} value={glaze}/>
                      </div>
                  </>:category==="Paintings"?
                  <>
                      {/* Medium */}
                      ...
                      <CustomInput placeholder="Input Painting Medium" backgroundColor="#FAFAFA" onChange={((e)=>{setMedium(e.target.value)})} value={medium}/>
                        </div>
                      {/* Condition */}
                      <div className="product__item">
                      ...
                      <div className="product__item">
                          ...
                          <CustomInput placeholder="Input Painting Size" backgroundColor="#FAFAFA" onChange={((e)=>{setSize(e.target.value)})} type="number" value={size}/>
                      </div>
                  </>:category==="Jewelry"&&
                  <>
                    {/* length */}
                    ...
                    <div className="product__item">
                        ...
                        <CustomInput placeholder="Input Stone Type" backgroundColor="#FAFAFA" onChange={((e)=>{setStoneType(e.target.value)})} value={stoneType}/>
                    </div>
                    {/* Metal type */}
                    <div className="product__item">
                        <label htmlFor="Name">Metal Type</label>
                        <CustomInput placeholder="Input Metal Type" backgroundColor="#FAFAFA" onChange={((e)=>{setMetalType(e.target.value)})} type="number" value={metalType}/>
                    </div>
                  </>
                }
              </FlexibleDiv>
           ...
           <StyledModal maskClosable={true}  open={openModal} centered closeIcon={null} className="modal" footer={null}>
                {
                  ...
                  <>
                    ...
                    <p style={{textAlign:"center",margin:"16px 0px", color:"#777777"}}>We ran into a problem while trying to update this product please try again</p>
                  <FlexibleDiv flexWrap="nowrap" gap="24px">
                    <Button border="1px solid #FC5353" color="#FC5353" hoverBg="white" hoverColor="var(--oosriPrimary)" width="100%" onClick={()=>setOpenModal(false)}>Retry</Button>
